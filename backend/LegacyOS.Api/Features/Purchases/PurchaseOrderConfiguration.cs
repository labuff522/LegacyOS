...
public class PurchaseOrderConfiguration : IEntityTypeConfiguration<PurchaseOrder>
{
    public void Configure(EntityTypeBuilder<PurchaseOrder> b)
    {
        ...
        b.Property(x => x.RefundedOn).HasColumnName("refunded_on");
        b.Property(x => x.RefundedByPortalUserId).HasColumnName("refunded_by_portal_user_id");
        b.Property(x => x.RefundReason).HasColumnName("refund_reason").HasMaxLength(500);
