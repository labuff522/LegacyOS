...
export function PortalHomePage() {
  ...
  async function checkout(body: { membershipPlanId?: string; productId?: string; athleteId?: string; discountCode?: string }, id: string) {
...
type PortalWaiverData = { athletes: { id: string; firstName: string; lastName: string }[]; waivers: { id: string; name: string; version: number; fileName: string; isRequired: boolean; organizationName: string; signedAthleteIds: string[] }[] };
