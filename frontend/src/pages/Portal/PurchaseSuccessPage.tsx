...
export function PurchaseSuccessPage() {
  ...
  return <Container maxWidth="sm" sx={{ py: 10 }}><Card><CardContent sx={{ p: 5, textAlign: 'center' }}>
    ...
    <Typography color="text.secondary" sx={{ my: 2 }}>Stripe is confirming your purchase. Your membership appears after the verified payment webhook is processed.</Typography>
